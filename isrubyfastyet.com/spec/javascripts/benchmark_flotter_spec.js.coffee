...
describe "BenchmarkFlotter", ->
  ...
  it "optionally takes a date", ->
    benchmark_flotter = new BenchmarkFlotter parsed_json, 2012-01-13
  ...
  describe "#flotData", ->
    ...
    it "only returns data after the start date", ->
      benchmark_flotter = new BenchmarkFlotter(parsed_json, new Date(1329203735000))
      expect(benchmark_flotter.flotData()).toEqual([
        {
          label: "jruby-head",
          data: [[new Date(1329203735000), 209.65935277938843]],
          fullData: [
            {
              "time_str":     "2012-02-14 07:15:35 UTC",
              "time_ms":      1329203735000,
